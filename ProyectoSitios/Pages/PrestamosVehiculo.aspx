<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrestamosVehiculo.aspx.cs" Inherits="ProyectoSitios.Pages.PrestamosVehiculo" %>
  ...
  <div class="side" style="z-index: 101;">
    <div class="cardHorizontal1" style="text-align:center; font-size:50px; font-weight: bold; color:black" > 
      ...
      <div class="cardHorizontal2" > 
          ...
          <br>
          <p style="font-size:25px"> Te ofrecemos tasas competitivas y rápidos tiempos de respuesta para comprar tu carro nuevo, seminuevo y usado; con opciones 
              leasing y crédito prendario.  </p>
          <asp:Button runat="server" ID="btncorreo" style="display:inline; width:auto; height:auto; font-size:15px; top: 0px; left: 0px;" class="button is-info is-outlined" Text="Información por correo" OnClick="btncorreo_Click"/>
    ...
    <img class="azul1"  src="../img/vehiculo.jpg"/>
  </div>
      </div>
