<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VistasSolicitudes.aspx.cs" Inherits="ProyectoSitios.Pages.VistasSolicitudes" %>
...
<body style="width: 100%; margin-left: auto; margin-right: auto;">
    <form id="form1" runat="server">
        ...
        <div>
            <nav class="navbar" style="z-index: 100; top: 35px; background-color: #061738; color: white" role="navigation" aria-label="dropdown navigation">
                <div class="navbar-menu" style="color: #ee8133;">
                    ...
                    <div class="navbar-end">
                        <a class="navbar-link" style="color: #ee8133;" href="../Pages/VistasInformacion.aspx">Vistas de solicitudes
                        </a>
                    </div>
                    <div class="navbar-end">
        ...
        <div style="margin-left: auto; margin-right: auto;">
            <h1 style="text-align: center; color: #061738; font-size: 50px; font-weight: bold;">Vistas de solicitudes</h1>
            <br />
            <br />
        ...
        <div class="contenedor">
            <div class="GraficosContenedor" style="height: auto;">
                <div class="PanelAD" style="height: auto;">
                    <div class="Grafico" style="height: auto;">

                        <div class="grafico1" style="border-radius: 0%; height: auto;">
                            <br />
                            <br />
                            <div style="width: 90%; text-align: center; align-items: center; margin-left: auto; margin-right: auto; height: auto">
                                <asp:Table ID="TablaVistas" runat="server" CssClass="table is-striped" ForeColor="#0B0550" HorizontalAlign="Center" Width="100%" Height="50px" Font-Size="X-Large" EnableTheming="False">
                                    <asp:TableHeaderRow ID="Table1HeaderRow" TableSection="TableBody" Style="color: white;" CssClass="CabezaTabla"
                                        ForeColor="white"
                                        BackColor="#061738"
                                        runat="server">
