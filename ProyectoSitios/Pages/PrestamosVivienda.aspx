<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrestamosVivienda.aspx.cs" Inherits="ProyectoSitios.Pages.PrestamosVivienda" %>
  ...
  <div class="side" style="z-index: 101;">
    <div class="cardHorizontal1" style="text-align:center; font-size:50px; font-weight: bold; color:black" > 
      ...
      <div class="cardHorizontal2" > 
          ...
          <br>
          <p style="font-size:25px"> Te ofrecemos una solución ágil de financiamiento para que estrenés en menor tiempo tu nuevo hogar.  </p>
    ...
    <img class="azul1"  src="../img/vivienda.jpg"/>
  </div>
      </div>
