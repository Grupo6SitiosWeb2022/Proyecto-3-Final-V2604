<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prestamos.aspx.cs" Inherits="ProyectoSitios.Pages.index" %>
  ...
  <div class="side" style="z-index: 101;">
    <div class="cardHorizontal1" style="text-align:center; font-size:50px; font-weight: bold; color:black" > 
      ...
      <div class="cardHorizontal2" > 
          ...
          <br>
          <p style="font-size:25px"> Con un préstamo personal de banco NAV, sus contratiempos ya no serán problemas, 
              solicite su préstamo personal ya.  </p>

          <asp:Button runat="server" ID="btncorreo" style="display:inline; width:auto; font-size:15px; top: 0px; left: 0px;" class="button is-info is-outlined" Text="Información por correo" OnClick="btncorreo_Click"/>
    ...
    <img class="azul1"  src="../img/requisitos1.jpg"/>
  </div>
      </div>
